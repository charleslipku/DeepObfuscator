...
if __name__ == '__main__':
    ...
    for epoch in range(args.epoch):
        ...
        # save loss
        with open('/home/al380/CelebA/output/loss/C_loss'+str(epoch)+'.json', 'w') as file:
            json.dump(C_loss_logger, file)
        file.close()

        with open('/home/al380/CelebA/output/loss/R1_loss' + str(epoch) + '.json', 'w') as file:
            json.dump(R1_loss_logger, file)
        file.close()

        with open('/home/al380/CelebA/output/loss/R2_loss' + str(epoch) + '.json', 'w') as file:
            json.dump(R2_loss_logger, file)
        file.close()

        with open('/home/al380/CelebA/output/loss/P_loss' + str(epoch) + '.json', 'w') as file:
            json.dump(P_loss_logger, file)
        file.close()

        #save acc
        with open('/home/al380/CelebA/output/loss/C_train_acc'+str(epoch)+'.json', 'w') as file:
            json.dump(C_train_acc, file)
        file.close()
        C_train_acc = []

        with open('/home/al380/CelebA/output/loss/P_train_acc'+str(epoch)+'.json', 'w') as file:
            json.dump(P_train_acc, file)
        file.close()
        P_train_acc = []

        # save models
        torch.save(E, '/home/al380/CelebA/output/adv/Encoder_epoch=' + str(epoch) + '.pth')
        torch.save(C, '/home/al380/CelebA/output/adv/Public_Classifier_epoch=' + str(epoch) + '.pth')
        torch.save(R, '/home/al380/CelebA/output/adv/Reconstruct_Decoder_epoch=' + str(epoch) + '.pth')
        torch.save(P, '/home/al380/CelebA/output/adv/Privacy_Extractor_epoch=' + str(epoch) + '.pth')
        ...
        with torch.no_grad():
            ...
            # save acc
            with open('/home/al380/CelebA/output/loss/C_test_acc' + str(epoch) + '.json', 'w') as file:
                json.dump(C_test_acc, file)
            file.close()
            C_test_acc = []

            with open('/home/al380/CelebA/output/loss/P_test_acc' + str(epoch) + '.json', 'w') as file:
